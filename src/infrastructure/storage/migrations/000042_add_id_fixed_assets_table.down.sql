...
ALTER TABLE fixed_assets_items_requests DROP COLUMN fixed_asset_id;
ALTER TABLE fixed_assets_items_requests ADD COLUMN fixed_asset_key VARCHAR(50) NOT NULL;
ALTER TABLE fixed_assets_items_requests ADD CONSTRAINT fk_fixed_asset FOREIGN KEY(fixed_asset_key) REFERENCES fixed_assets(key);
